...
<html manifest="mirawatt-iphone.manifest.php">
    <head>
        <meta charset="UTF-8" />
        <title>Mirawatt - for TED5000</title>
        <link rel="stylesheet" href="mirawatt-wp-style.css" type="text/css" media="screen">
        <script type="text/javascript" charset="utf-8">
            if((navigator.userAgent.match(/iPhone/i)) || (navigator.userAgent.match(/iPod/i))) {
                window.location = "iphone-ted.html";
            }
        </script>
    ...
    <body>
        <div id="wrapper">
            <div id="header">
                <div id="logo">
                    <a href="http://ted.mirawatt.com/">
                        <img style="margin-top: -15px;" src="mirawatt-wp-pixel-logo-400x75-trans.png">
                    </a>
                </div>
                ...
                <div id="contentwrapper">
                    <div class="topPost">
                        ...
                        <div class="cleared"></div>
                            ...
                            <!-- height to accomodate info section on chrome... scroll=no has no effect --><br />
                            <iframe src ="http://ted.mirawatt.com/iphone-ted.html" width="320px"  height="560px" frameborder="0" scrolling="no" allowTransparency="true"></p>
